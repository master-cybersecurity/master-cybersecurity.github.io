...
class SendViewSend extends acymailingView
{
	...
	function scheduleconfirm(){
		...
		$hours = JHTML::_('select.genericlist',   $listHours, 'sendhours', 'class="inputbox" size="1" style="width:50px;"', 'value', 'text', $defaultHours);
		for($i=0; $i<60; $i+=5){ $listMinutess[] = JHTML::_('select.option', $i, ($i<10?'0'.$i:$i)); }
		$minutes = JHTML::_('select.genericlist',   $listMinutess, 'sendminutes', 'class="inputbox" size="1" style="width:50px;"', 'value', 'text', $defaultMinutes);
