...
<form name="adminForm" id="adminForm" action="index.php" method="post" class="form form-horizontal form-horizontal-wide">
	...
	<fieldset>
		...
		<div class="control-group">
			<label class="control-label" for="xssshield_allowphp"><?php echo JText::_('ATOOLS_LBL_WAF_OPT_XSSSHIELD_PHP'); ?></label>
			<div class="controls">
		...
		?>
		<div class="control-group">
			<label class="control-label" for="xssshield_safe_keys"><?php echo JText::_('ATOOLS_LBL_WAF_OPT_XSSSHIELD_SAFE_PARAMS'); ?></label>
			<div class="controls">
				<input type="text" size="20" name="xssshield_safe_keys" value="<?php echo $this->wafconfig['xssshield_safe_keys'] ?>" />
			</div>
		</div>
	...
	<fieldset>
		<legend><?php echo JText::_('ATOOLS_LBL_WAF_OPTGROUP_EXCEPTIONS') ?></legend>
		...
		<div class="control-group">
			<label class="control-label" for="whitelist_domains"><?php echo JText::_('ATOOLS_LBL_WAF_OPT_WHITELIST_DOMAINS'); ?></label>
			<div class="controls">
				<input type="text" class="input-large" name="whitelist_domains" id="whitelist_domains" value="<?php echo $this->wafconfig['whitelist_domains'] ?>">
			</div>
		</div>
	...
	<fieldset>
		...
		<div class="control-group">
			<label class="control-label" for="reasons_nolog"><?php echo JText::_('ATOOLS_LBL_WAF_OPT_REASONS_NOLOG'); ?></label>
			<div class="controls">
				<input type="text" class="input-large" name="reasons_nolog" id="reasons_nolog" value="<?php echo $this->wafconfig['reasons_nolog'] ?>">
			</div>
		</div>

		<div class="control-group">
			<label class="control-label" for="reasons_noemail"><?php echo JText::_('ATOOLS_LBL_WAF_OPT_REASONS_NOEMAIL'); ?></label>
			<div class="controls">
				<input type="text" class="input-large" name="reasons_noemail" id="reasons_noemail" value="<?php echo $this->wafconfig['reasons_noemail'] ?>">
			</div>
		</div>
	</fieldset>
