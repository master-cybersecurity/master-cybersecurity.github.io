...
.red {
	...
	<div id="installer-right">
		...
		<?php if ($messages['modules']) { ?>
			...
			<?php } ?>
		<?php } ?>
		<h2>Changelog v1.50.6</h2>
		<ul class="version-history">
			<li><span class="version-upgraded">Upg</span> 'Additional Emails' now open in the same language as the form is currently being edited in.</li>
			<li><span class="version-upgraded">Upg</span> New 'Additional Emails' now display the language they'll be created in.</li>
			<li><span class="version-fixed">Fix</span> New 'Additional Emails' are created in the same language the form is currently being edit in.</li>
			<li><span class="version-fixed">Fix</span> Translations for 'Additional Emails' were not being saved correctly.</li>
			<li><span class="version-fixed">Fix</span> Some backups were not restoring even though the backups were genuine due to an implementation bug.</li>
			<li><span class="version-fixed">Fix</span> Prevent double encoding of GZIP backups on Google Chrome when servers had GZIP content compression enabled.</li>
			<li><span class="version-fixed">Fix</span> When restoring an invalid backup, 'null' would show up instead of an actual message.</li>
		</ul>
